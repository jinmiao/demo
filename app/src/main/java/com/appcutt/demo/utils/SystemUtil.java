...
import com.appcutt.libs.log.Logger;
import com.appcutt.libs.log.LoggerFactory;
...
public class SystemUtil {
    ...
    public static void exitApp() {
        ...
        intent.setAction(Constants.ActionConstants.ACTION_EXIT_APP);
        intent.addCategory(Intent.CATEGORY_DEFAULT);
        getLocalBroadcastManager(AppUtil.getAppContext()).sendBroadcast(intent);
    }
